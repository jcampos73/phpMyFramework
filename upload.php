...
<!-- jQuery UI styles -->
<link rel="stylesheet" href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/themes/start/jquery-ui.css" id="theme">
<!-- Demo styles -->
  ...
  <tr>
    ...
    <div class="fileupload-buttonbar">
        <div class="fileupload-buttons">
			...
			<input name="idProducto" id="idProducto" type="hidden" value="<?php echo (get_magic_quotes_gpc()) ? $_GET['idProducto'] : addslashes($_GET['idProducto'])?>">
    ...
    <table role="presentation" align="center"><tbody class="files"></tbody></table>
</form>
<br>
